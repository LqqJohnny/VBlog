<template lang="html">
  <div class="noContent">
    <nav class="shelf">
      <router-link to="/" class="book home-page">Home page</router-link>
      <router-link to="/" class="book about-us">About us</router-link>
      <router-link to="/"  class="book faq">关于我们</router-link>
      <router-link to="/"  class="book contact">首页</router-link>
